...
<script>
    function reload() {
        ...
        if (year === "") {
            ...
            document.frm.action = "monthyearrep.jsp";
            document.frm.submit();
        }
        return true;
    }
...
<body>
    ...
    <hr color="#510051">
    <form name="frm" onsubmit="return reload()">
        <table width="100%" align="center" border="1" class="t6">
            <tr>
                <td class="t7"><br>Select Month &nbsp;&nbsp;&nbsp;
                    ...
                    Enter Year &nbsp;&nbsp;&nbsp;
                    <input type="text" name="year" size="8" value="${not empty param.year ? param.year : ''}">
                    &nbsp;&nbsp;&nbsp;
                    <input type="submit" value="Submit" class="th1"><br>
                </td>
            </tr>
            <tr>
                <td>
