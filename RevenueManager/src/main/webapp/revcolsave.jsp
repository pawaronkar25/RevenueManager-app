...
<jsp:useBean id="bean" class="com.rr.beans.RevColSaveBean"/>
                    ...
                    <td>
                        ...
                        <c:choose>
                            <c:when test="${inserted}">
                                <tr>
                                    <td class="pass">Revenue Collection Inserted Successfully</td>
                                </tr>
                            </c:when>
                            <c:otherwise>
                                <tr>
                        ...
                        <tr>
                            <td class="pass"><a href="CollectionEntry.jsp">Back</a></td>
                        </tr>
                    </td>
                </tr>
            </table>
